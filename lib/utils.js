...
// Commented out 07.11.2018 because this code breaks jQuery.
// If we are in NODE
...
wdi = {};
wdi.workerScriptPath = "application/WorkerProcess.js";
wdi.resourcesPath = "resources/";
wdi.DomainObject = {};
...
wdi.Utils = {
    generateWebSocketUrl: function(protocol, host, port, destHost, destPort, type, destInfoToken) {
        ...
        return scheme + host;
        // url = scheme + host + "/" + "?ver=2&token=" + port;
        // return url;
    }
};
